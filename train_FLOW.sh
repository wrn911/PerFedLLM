...
DATA_TYPES=("net") #"net" "call" "sms" "traffic"

device="cuda:3"               # 指定使用的 GPU
llm="GPT2"                    # 可选: "BERT", "GPT2", "DeepSeek", "Qwen3"
llm_dim=768                   # 768 768 1536 1024
local_ep=5
epoch=10
...
model_type="simpletimellm"    # 显式定义模型类型，避免未定义变量

# ========== 启动训练循环 ==========
for dataset in "${DATASETS[@]}"; do
    for data_type in "${DATA_TYPES[@]}"; do
        # 构建实验名称
        exp_name="${model_type}_${dataset}_${data_type}_${fed_algorithm}_${llm}"
